...
```{r versions, results = 'hold', echo = FALSE, dev = 'jpeg'}
...
```{r Mb-run, eval = runsim, cache = TRUE, warning = FALSE}
...
```{r Mb oneoff, eval = runsim, cache = TRUE, message = FALSE, warning = FALSE}
source('../setup.R')
grid <- make.grid(nx = 8, ny = 8, spacing = 40, detector = "multi")
