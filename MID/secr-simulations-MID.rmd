...
```{r MID1 scenario summary, cache = TRUE}
scenarioSummary(scen1, grid)
```

```{r MID1-run, eval = runsim, cache = TRUE, message = FALSE, warning = FALSE, results = "hide"}
...
```{r MID2 scenario summary, cache = TRUE}
scenarioSummary(scen2, grid)
```

```{r MID2-run, eval = runsim, cache = TRUE, message = FALSE, warning = FALSE, results = "hide"}
...
```{r MID3 scenario summary, cache = TRUE}
scenarioSummary(scen3, grid)
```

```{r MID3-run, eval = runsim, cache = TRUE, message = FALSE, warning = FALSE, results = "hide"}
...
```{r MID4 scenario summary, cache = TRUE}
scenarioSummary(scen4, grid)
```

```{r MID4-run, eval = runsim, cache = TRUE, message = FALSE, warning = FALSE, results = "hide"}
...
```{r MID5 scenario summary, cache = TRUE}
scenarioSummary(scen5, grid)
```

```{r MID5-run, eval = runsim, cache = TRUE, message = FALSE, warning = FALSE, results = "hide"}
